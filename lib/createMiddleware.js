      ...
      return function (action) {
        ...
        var loginSuccess = function loginSuccess(user) {
          ...
          if (options.redirectAfterLogin) {
            ...
            // // dynamic redirect
            // if (options.dynamicRedirect && currentRoute.redirect) {
            //   if (!redirect.userId || redirect.userId === user[options.userIdentifier]) currentRoute.redirect
            // }
            ...
            if (typeof redirect === 'string') redirect = { id: redirect
              ...
              // // only redirect when user ids match if redirect is restricted by user (after DESTROY_SESSION)
              // if (
              //   !redirect.userId ||
              //   redirect.userId === user[options.userIdentifier]
              // )
